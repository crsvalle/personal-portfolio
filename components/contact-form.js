  ...
  return (
    <section className='relative isolate bg-black text-white' id="contact">
      ...
      <div className='relative mb-12'>
        <h2 className="text-3xl font-bold text-center mb-3">Connect with me!</h2>

        <div className='mt-8 flex justify-center space-x-6'>
          <Link href="https://www.linkedin.com/in/cris-valle/" target="_blank">
            <span className="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#0a66c2]">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path
                  d="M100.28 448H7V148h93.28zm-46.14-344C24.56 104 0 79.44 0 51.86 0 24.29 24.56 0 54.14 0 83.72 0 108.28 24.29 108.28 51.86c0 27.58-24.56 52.14-54.14 52.14zM447.92 448h-93.09V302.4c0-34.7-12.3-58.4-43.14-58.4-23.53 0-37.57 15.84-43.71 31.13-2.24 5.46-2.79 13.07-2.79 20.73V448h-93.08s1.24-250.9 0-276.36h93.08v39.1c-.2.3-.48.7-.68 1h.68v-1c12.39-19.09 34.53-46.36 84.07-46.36 61.37 0 107.41 40.2 107.41 126.53V448z" />
              </svg>
            </span>
          </Link>


          <Link href="https://www.github.com/crsvalle" target="_blank">
        ...
        >
          ...
          <Button
            type='submit'
            className='mt-6 w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-blue-400'
