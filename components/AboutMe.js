...
export default function AboutMe() {
  return (
    <section className="flex flex-col-reverse items-start gap-x-10 gap-y-2 pb-24 mt-24 md:flex-row md:items-center max-w-2xl mx-auto" id="about">
      <section className="flex flex-col md:flex-row items-center gap-6 md:gap-10 pb-24" >
